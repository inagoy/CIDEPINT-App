 ...
 */
export function validateEmail(inputId, errorId) {
 ...
 * @return {void} This function does not return anything.
 */
export function validateJustText(inputId, errorId) {
 ...
 */
export function validateJustNumber(inputId, errorId) {
	const input = document.getElementById(inputId);
	const error = document.getElementById(errorId);
 ...
 */
export function validateUsername(inputId, errorId) {
 ...
 */
export function validatePassword(inputId, errorId) {
 ...
 */
export function validateDireccion(inputId, errorId) {
	const input = document.getElementById(inputId);
	const error = document.getElementById(errorId);
 ...
 * @return {boolean} Returns true if the phone number is valid, false otherwise
 */
export function validateWebsite(inputId, errorId) {
 ...
 */
export function validateKeywords(inputId, errorId) {
	const input = document.getElementById(inputId);
	const error = document.getElementById(errorId);
...
export function emptyInputFields(modal) {
...
export function validateFormInstitution() {
